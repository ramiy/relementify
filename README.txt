...
Choose from hundreds of predefined designs for each of your Elementor widgets.
...
Note that the plugin uses Elementor’s builtin functionality to paste styles. Meaning that you can Undo these styles and even see the change in the Elementor History panel.
...
When the user opens the preset panel, an API request is sent to the server with a widget slug to retrieve designs specific to that widget.
...
Currently, no — but it’s on our roadmap. In future releases, you’ll be able to save presets locally on your site or to the Relementify cloud.

= Do I need to know how to code? =

No. Relementify extends Elementor to provide an easy-to-use graphical interface, from which you can choose presets without using code.

= Do I need to know how to design? =

No. Simply choose from professionally designed widgets and focus on creating your own website.
